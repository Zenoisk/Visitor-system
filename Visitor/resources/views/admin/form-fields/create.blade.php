@extends('layouts.admin', ['title' => 'Add Form Field', 'heading' => 'Add Form Field'])

@section('content')
<form method="POST" action="{{ route('admin.form-fields.store') }}" class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
    @csrf
